...
const pizza = document.querySelector("#phone-pizza-background");
landing_page_button.addEventListener("mousedown", function () {
  landing_page_button.style.boxShadow =
    "inset 0px 0px 7px 0px rgba(66, 68, 90, 1)";
});
...
onscroll = (evt) => {
  pizza.style.transform = "rotate(" + window.pageYOffset/2 + "deg)";
};
